...
struct LockScreenAlertView: View {
    ...
    var body: some View {
        ...
        .scaleEffect(isContentVisible ? 1 : NotchMotionGraph.contentScaleFrom, anchor: .center)
        .blur(radius: isContentVisible ? 0 : NotchMotionGraph.contentBlurRadius)
        .opacity(isContentVisible ? 1 : 0)
        .animation(NotchMotionGraph.animation(for: .contentEnter, reduceMotion: reduceMotion), value: isContentVisible)
        .onAppear {
