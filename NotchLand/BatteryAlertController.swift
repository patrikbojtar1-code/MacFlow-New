...
enum BatteryPresentationTiming {
    static let expandDuration = NotchMotionGraph.measurement(for: .interruption).duration
    static let contentRevealDuration = NotchMotionGraph.measurement(for: .contentEnter).duration
